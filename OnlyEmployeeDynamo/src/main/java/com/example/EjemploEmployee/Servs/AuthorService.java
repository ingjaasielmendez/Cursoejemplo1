...
import com.example.EjemploEmployee.AuthorRepository;
...
@Service public class AuthorService {
	  ...
	  Author response; Optional<Author> authorFound = authorrepository.findByName(name);
	  ...
	  Author response2; Optional<Author> authorFound2 = authorrepository.findByName(name);
